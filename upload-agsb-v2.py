...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "cddaye"         # 用户名
UUID = "ba7bd8b7-0f22-4b8a-aa2e-2d18aa60d345"                     # UUID，留空则自动生成
PORT = 49995                   # Vmess端口，留空或0则自动生成
DOMAIN = "https://ye.yemener.cloudns.be"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMzZkMjhiOTBlNDM0MTM2OTc1ODE3MDY3N2IzODNkMjQiLCJ0IjoiMjliZDk2MzMtZGEwOC00MGRmLTk2NDEtMzM5ZTEzYmI4MTA0IiwicyI6Ik5qTmhNMlkyWW1VdE1XUm1aaTAwTmpBNUxUazFNVEF0TW1JNE5HTXlPVE5oTkdabSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
